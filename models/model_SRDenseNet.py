...
import time
from SRDenseNet.modules.networks import *
from SRDenseNet.utils.data_loader import Dataset_Loader
import numpy as np
...
#======================================================
    def build_model(self):
        ...
        self.input = tf.placeholder(tf.float32, shape=[BS, H//self.config.scale, W//self.config.scale, CH], name='input')
        ...
        """ model """
        G_Network = partial(SRDense, scope_name = "Generator", scale = self.config.scale)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--patch_size", type=int, default=24, help='Minipatch size(global)')
